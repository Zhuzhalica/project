...
import org.example.filter_one.metric.MetricAggregate;
...
public class ColorInverseFilterKafkaService {
    ...
    public void read(@Payload ConsumerRecord<String, String> record, Acknowledgment acknowledgment) {
        ...
        try {
            ...
            requestMetric.excpetion(record, e);
        } finally {
            requestMetric.afterAction(record);
        }

    }

    private void ProcessRequest(ConsumerRecord<String, String> record, Acknowledgment acknowledgment) throws Exception {
